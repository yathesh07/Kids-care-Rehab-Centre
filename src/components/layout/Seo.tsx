...
export const organisationSchema = {
  ...
  amenityFeature: {
    ...
    name: 'Wheelchair-assisted lift access',
    value: true,
  },
  availableService: [
    'Paediatric physiotherapy',
    'Adult and senior-citizen physiotherapy',
    'Pain and mobility rehabilitation',
    'Speech and language therapy',
    'Sensory integration therapy',
    'Oral-motor therapy',
    'Behaviour therapy and social-skills training',
    'Autism, ADHD and learning support',
    'Special education and KCR Special School admission',
    'Developmental assessment, therapy goals and home programmes',
    'BRAIN2ACT, Brain Gym and movement-based activities',
    'Vocational training and parent-empowerment programmes',
